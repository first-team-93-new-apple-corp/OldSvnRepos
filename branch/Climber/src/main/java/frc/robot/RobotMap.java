...
public class RobotMap {
	...
	public static final int ScalarMotor = 8;
	public static final int ClimberDriver = 9;
	...
	public static final int ScalarEncoder1 = 8;
	public static final int ScalarEncoder2 = 9;

	public static final int BarDrop = 10;
