...
public class ElevatorHeight extends Command {
  ...
  protected boolean isFinished() {
    return ((Elevator.ElevatorPIDUp.isEnabled() && Elevator.ElevatorPIDUp.onTarget()) || (Elevator.ElevatorPIDDown.isEnabled() && Elevator.ElevatorPIDDown.onTarget()) && elevatorSpeed < 0.5) == true;
