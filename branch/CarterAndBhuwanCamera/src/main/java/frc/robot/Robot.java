...
public class Robot extends TimedRobot {
	...
	public static HatchRemoval hatchRemoval;
	...
	public void robotInit() {
		...
		OI.selectManualControl.isActive = true;
	...
	public void teleopPeriodic() {
		...
		SmartDashboard.putNumber("setpoint", OI.lockRotationDrive.lockedAngle);
		SmartDashboard.putBoolean("Have hatch: ", !HatchManipulator.hatchDetectorLeft.get() && !HatchManipulator.hatchDetectorRight.get());
		SmartDashboard.putBoolean("Have cargo: ", !CargoManipulator.lightSensor.get());
		...
		SmartDashboard.putData("FLANGLE PID", Drive.BLModule.rotatePID);
		SmartDashboard.putData("FRANGLE PID", Drive.BLModule.rotatePID);
