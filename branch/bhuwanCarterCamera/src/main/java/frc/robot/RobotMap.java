...
public class RobotMap {
	...
	public static final int ElevatorEncoderA = 27;
	public static final int ElevatorEncoderB = 28;
	...
	public static final int HatchManipA = 0;
	public static final int HatchManipB = 1;
	public static final int HatchDetectorLeft = 30;
	public static final int HatchDetectorRight = 29;
	public static final int HatchManip = 25;

	public static final int RotateManip = 7; 
	public static final int HatchRemoverRotator = 5; 
	...
	public static final int elevatorBottomLimit = 26;
	public static final int wristUpLimit = 10; 
