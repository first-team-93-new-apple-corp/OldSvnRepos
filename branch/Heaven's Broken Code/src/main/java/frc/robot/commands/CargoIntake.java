...
public class CargoIntake extends Command {
  ...
  protected void execute() {
    CargoManipulator.leftCargoIntake.set(-1.0);
    CargoManipulator.rightCargoIntake.set(1.0);
  ...
  @Override
  protected void end() {
    CargoManipulator.leftCargoIntake.stopMotor();
    CargoManipulator.rightCargoIntake.stopMotor();
    //stops motors
  }
