...
public class AutoCommandsMilwaukee extends CommandGroup {
    ...
    public AutoCommandsMilwaukee() {
        ...
        // final int PLAN_SET_BIN_ON_TOTE = 9;
        ...
        // case PLAN_SET_BIN_ON_TOTE:
        // // Grabs bin, sets on yellow tote,then drives to center. Not tested.
        // addSequential(new AutoGrabHack());
        // addSequential(new SleepCommand(1.0));
        // addSequential(new MoveElevator(100, 10.0));
        // addParallel(new DriveForward(112, 5.0));
        // addSequential(new MoveElevator(5, 10.0));
        // addSequential(new ObjectGrabber());
        // addSequential(new SleepCommand(1.0));
        // addSequential(new MoveElevator(-100, 10.0));
        // addSequential(new ObjectGrabber());
        // addSequential(new SleepCommand(1.0));
        // addSequential(new TurnRight(90.0, 5.0));
        // addSequential(new DriveForward(DISTANCE_FROM_TOTE_TO_AUTO, 10.0));
        // addSequential(new MoveElevator(0, 10.0));
        // break;

        // case PLAN_DRIVE_BACKWARD:
        // // Drives backwards, meant to push a tote/bin out of the way for
        // // another team.
        // addSequential(new DriveForward(BACKWARD_DISTANCE_FROM_TOTE_TO_AUTO,
        // 10.0));
        //
        // break;
        default:
