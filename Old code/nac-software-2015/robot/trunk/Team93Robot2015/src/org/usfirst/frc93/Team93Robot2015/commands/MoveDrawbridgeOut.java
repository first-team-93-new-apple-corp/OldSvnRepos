...
/**
 * This command moves the drawbridge out
 * 
 */
public class MoveDrawbridgeOut extends Command {

    public MoveDrawbridgeOut() {
    ...
    protected void initialize() {
         ...
         */
        System.out.println("Drawbridge Moving Out");
    }
    ...
    protected void end() {
         ...
         *            declutter the Riolog and be able to see it easier.
         */
        System.out.println("Drawbridge Out Command Finished");
    }
