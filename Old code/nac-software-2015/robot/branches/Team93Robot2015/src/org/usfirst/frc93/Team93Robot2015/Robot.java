...
import org.usfirst.frc93.Team93Robot2015.commands.VisionProcessor;
...
public class Robot extends IterativeRobot {
    ...
    public static VisionProcessor VisionProc;
    ...
    public void robotInit() {
        ...
        VisionProc = new VisionProcessor();
        ...
        // sautonomousCommand = new AutonomousCommands();
        autonomousCommand = new AutonomousCommandGroup();

        // RobotMap.camera.startAutomaticCapture();

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        // RobotMap.camera.startAutomaticCapture("cam0");
        VisionProc.setRunWhenDisabled(true);
        VisionProc.start();
    }
