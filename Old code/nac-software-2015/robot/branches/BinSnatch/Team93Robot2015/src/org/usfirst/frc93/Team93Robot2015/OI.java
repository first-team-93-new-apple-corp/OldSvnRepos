...
public class OI {
    ...
    public OI() {
        ...
        Button rakeDeployButton = new JoystickButton(OI.operator, 1);

        runDriveForwards.whenPressed(new DriveForward(1000));
        ...
        SmartDashboard.putData("SleepCommand", new SleepCommand(0));
    ...
    public static double getDriverLY() {
        return (deadzone(driver.getRawAxis(1), 0.1));
    }

    public static double getDriverRY() {
        return (deadzone(driver.getRawAxis(3), 0.1));
    }
