...
public class PIDOutputGroup implements PIDOutput {
     ...
     *            PIDControllerGroup.
     * @param gainA
     *            The multiplier for the first SpeedController.
     * @param gainB
     *            The multiplier for the second SpeedController.
     */
    public PIDOutputGroup(PIDOutput controllerA, PIDOutput controllerB,
            double gainA, double gainB) {
