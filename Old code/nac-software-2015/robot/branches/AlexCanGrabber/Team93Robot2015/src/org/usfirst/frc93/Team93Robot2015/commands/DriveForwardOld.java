 ...
 *
 */
public class DriveForwardOld extends Command {

    int m_driveDistance;

    private boolean finished = false;

    public DriveForwardOld(int driveDistance) {
    ...
    protected void execute() {
        ...
        SmartDashboard.putDouble("LeftEncoder", RobotMap.leftMotorEncoder.get());
