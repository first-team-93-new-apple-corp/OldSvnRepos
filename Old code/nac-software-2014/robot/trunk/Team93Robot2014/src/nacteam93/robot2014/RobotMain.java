...
import nacteam93.robot2014.subsystems.Shooter;
/**
...
public class RobotMain extends IterativeRobot {
    ...
    public void robotInit() {
        ...
        RobotMap.CompressorOne.start();
        RobotMap.winchPID.setSetpoint(0.0);
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        SmartDashboard.putBoolean("Fish's Button", Shooter.isRetracted());
    }
