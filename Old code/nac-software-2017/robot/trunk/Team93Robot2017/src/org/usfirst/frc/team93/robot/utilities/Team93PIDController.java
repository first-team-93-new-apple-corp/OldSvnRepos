...
public class Team93PIDController implements LiveWindowSendable
{
	...
	/**
	 * @codereview josh.hawbaker 4.6.17 Trying to remove warnings. Removed
	 * m_freed which was initialized to false and set to true around line 303.
	 * Also removed m_usingPercentTolerance which was initialized, but never set
	 * or used. Removed setTolerance method, which was deprecated and unused.
	 */
	 ...
	 * @param KmaximumIContribution the maximum value that I * totalError can
	 * contribute to final motor value
	 ...
	 * is 50ms.
	 */
	public Team93PIDController(double Kp, double Ki, double Kd, double Kf, double KmaximumIContribution,
	 ...
	 * is 50ms.
	 */
	public Team93PIDController(double Kp, double Ki, double Kd, double KmaximumIContribution, PIDSource source,
	 ...
	 *
	 * @param minimumIContribution the minimum I Contribution to PID value
	 * @param maximumIContribution the maximum I Contribution to PID value
	 */
