...
public class RobotMapReal extends RobotMap
{
	...
	private RobotMapReal()
	{
		/// Drive Sensors
		// Encoders
		LEFT_FRONT_DRIVE_ENCODER_PIN = new EncoderPin(1, 0);
		LEFT_BACK_DRIVE_ENCODER_PIN = new EncoderPin(3, 2);
		...
		/// Actuators
		// Drive Speed Motors
		DRIVE_LEFT_FRONT_PIN = 1;
		DRIVE_LEFT_BACK_PIN = 3;
		DRIVE_RIGHT_FRONT_PIN = 0;
		DRIVE_RIGHT_BACK_PIN = 2;
		// Wheel Direction Motors
		DRIVE_DIRECTION_LEFT_FRONT_PIN = 3;
		DRIVE_DIRECTION_LEFT_BACK_PIN = 1;
		DRIVE_DIRECTION_RIGHT_FRONT_PIN = 4;
		DRIVE_DIRECTION_RIGHT_BACK_PIN = 2;
		
		// Gear Manipulator Motors
		// check these pins!
		GEAR_BELT_MOTOR_PIN = 6;
		GEAR_INTAKE_FRONT_MOTOR_PIN = 5;
		GEAR_INTAKE_BACK_MOTOR_PIN = 4;
		// Gear Manipulator Pneumatics
		GEAR_DEFLECTOR_SOLENOID_PIN = new SolenoidPin(6, 7);
		GEAR_FRONT_SOLENOID_PIN = new SolenoidPin(2, 3);
		GEAR_BACK_SOLENOID_PIN = new SolenoidPin(0, 1);
