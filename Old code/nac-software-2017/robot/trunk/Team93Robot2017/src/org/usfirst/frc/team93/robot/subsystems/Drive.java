...
import org.usfirst.frc.team93.robot.commands.drive.CrabDriveContinuous;
import org.usfirst.frc.team93.robot.utilities.AnalogGyroPIDSource;
import org.usfirst.frc.team93.robot.utilities.EncoderExtended;
...
public class Drive extends Subsystem
{
	...
	// only used in CrabDriveContinuous, the default yaw value desired
	private static double m_defaultYaw = 0.0;
	// whether to hold default yaw
	private static boolean m_holdYaw = true;
	// whether we want to hold any yaw or not
	private static boolean m_holdYawControl = false;
	
	/// Sensors
	// Encoders
	private static Encoder DRIVE_ENCODER_LEFT_FRONT_SENSOR;
	private static Encoder DRIVE_ENCODER_LEFT_BACK_SENSOR;
	private static Encoder DRIVE_ENCODER_RIGHT_FRONT_SENSOR;
	private static Encoder DRIVE_ENCODER_RIGHT_BACK_SENSOR;
	
	private static EncoderExtended DRIVE_ENCODER_LEFT_FRONT;
	private static EncoderExtended DRIVE_ENCODER_LEFT_BACK;
	private static EncoderExtended DRIVE_ENCODER_RIGHT_FRONT;
	private static EncoderExtended DRIVE_ENCODER_RIGHT_BACK;
	
	public static PIDSourceExtended DRIVE_ENCODER_LEFT_FRONT_DISTANCE;
	public static PIDSourceExtended DRIVE_ENCODER_LEFT_BACK_DISTANCE;
	public static PIDSourceExtended DRIVE_ENCODER_RIGHT_FRONT_DISTANCE;
	public static PIDSourceExtended DRIVE_ENCODER_RIGHT_BACK_DISTANCE;
	
	public static PIDSourceExtended DRIVE_ENCODER_LEFT_FRONT_RATE;
	public static PIDSourceExtended DRIVE_ENCODER_LEFT_BACK_RATE;
	public static PIDSourceExtended DRIVE_ENCODER_RIGHT_FRONT_RATE;
	public static PIDSourceExtended DRIVE_ENCODER_RIGHT_BACK_RATE;
	...
	public Drive()
	{
		...
		/// Sensors
		// Encoders
		DRIVE_ENCODER_LEFT_FRONT_SENSOR = new Encoder(leftFrontDriveEncoderPinA, leftFrontDriveEncoderPinB);
		DRIVE_ENCODER_LEFT_BACK_SENSOR = new Encoder(leftBackDriveEncoderPinA, leftBackDriveEncoderPinB);
		DRIVE_ENCODER_RIGHT_FRONT_SENSOR = new Encoder(rightFrontDriveEncoderPinA, rightFrontDriveEncoderPinB);
		DRIVE_ENCODER_RIGHT_BACK_SENSOR = new Encoder(rightBackDriveEncoderPinA, rightBackDriveEncoderPinB);
		
		DRIVE_ENCODER_LEFT_FRONT = new EncoderExtended(DRIVE_ENCODER_LEFT_FRONT_SENSOR);
		DRIVE_ENCODER_LEFT_BACK = new EncoderExtended(DRIVE_ENCODER_LEFT_BACK_SENSOR);
		DRIVE_ENCODER_RIGHT_FRONT = new EncoderExtended(DRIVE_ENCODER_RIGHT_FRONT_SENSOR);
		DRIVE_ENCODER_RIGHT_BACK = new EncoderExtended(DRIVE_ENCODER_RIGHT_BACK_SENSOR);
		
		DRIVE_ENCODER_LEFT_FRONT_DISTANCE = new PIDSourceExtended(DRIVE_ENCODER_LEFT_FRONT.distance);
		DRIVE_ENCODER_LEFT_BACK_DISTANCE = new PIDSourceExtended(DRIVE_ENCODER_LEFT_BACK.distance);
		DRIVE_ENCODER_RIGHT_FRONT_DISTANCE = new PIDSourceExtended(DRIVE_ENCODER_RIGHT_FRONT.distance);
		DRIVE_ENCODER_RIGHT_BACK_DISTANCE = new PIDSourceExtended(DRIVE_ENCODER_RIGHT_BACK.distance);
		
		DRIVE_ENCODER_LEFT_FRONT_RATE = new PIDSourceExtended(DRIVE_ENCODER_LEFT_FRONT.rate);
		DRIVE_ENCODER_LEFT_BACK_RATE = new PIDSourceExtended(DRIVE_ENCODER_LEFT_BACK.rate);
		DRIVE_ENCODER_RIGHT_FRONT_RATE = new PIDSourceExtended(DRIVE_ENCODER_RIGHT_FRONT.rate);
		DRIVE_ENCODER_RIGHT_BACK_RATE = new PIDSourceExtended(DRIVE_ENCODER_RIGHT_BACK.rate);
		...
		/// PID Sources
		// Crab Drive Speed PIDSource
		DRIVE_ENCODERS = new MedianPIDSource(DRIVE_ENCODER_LEFT_FRONT_DISTANCE, DRIVE_ENCODER_LEFT_BACK_DISTANCE, DRIVE_ENCODER_RIGHT_FRONT_DISTANCE, DRIVE_ENCODER_RIGHT_BACK_DISTANCE);
		
		// CANTalons for drive platform, Victors for real
		DRIVE_LEFT_FRONT_TALON = new VictorSP(RobotMap.getMap().DRIVE_LEFT_FRONT_PIN);
		DRIVE_LEFT_BACK_TALON = new VictorSP(RobotMap.getMap().DRIVE_LEFT_BACK_PIN);
		DRIVE_RIGHT_FRONT_TALON = new VictorSP(RobotMap.getMap().DRIVE_RIGHT_FRONT_PIN);
		DRIVE_RIGHT_BACK_TALON = new VictorSP(RobotMap.getMap().DRIVE_RIGHT_BACK_PIN);
		...
		CRAB_DRIVE_COORDINATOR = new CrabDriveCoordinator(0.02, 0, 0, GYRO, CRAB_DRIVE_LEFT_FRONT, CRAB_DRIVE_LEFT_BACK, CRAB_DRIVE_RIGHT_FRONT, CRAB_DRIVE_RIGHT_BACK, CRAB_DRIVE_DIRECTION_LEFT_FRONT,
				CRAB_DRIVE_DIRECTION_LEFT_BACK, CRAB_DRIVE_DIRECTION_RIGHT_FRONT, CRAB_DRIVE_DIRECTION_RIGHT_BACK);
		disableCrabDrive();
		
		// Drive Distance Control
		DRIVE_DISTANCE_CONTROLLER = new Team93PIDController(0.0015, 0.001, 0, 0, DRIVE_ENCODERS, CRAB_DRIVE_COORDINATOR.speedReceiver);
	...
	{
		GYRO.reset();
		DRIVE_ENCODER_LEFT_FRONT_SENSOR.reset();
		DRIVE_ENCODER_LEFT_BACK_SENSOR.reset();
		DRIVE_ENCODER_RIGHT_FRONT_SENSOR.reset();
		DRIVE_ENCODER_RIGHT_BACK_SENSOR.reset();
	}
	...
	/**
	 * Sets the default yaw, ONLY USED IN CrabDriveContinuous
	 * 
	 * @param yaw
	 */
	public static void setDefaultYaw(double yaw)
	{
		m_defaultYaw = yaw;
	}
	
	/**
	 * Gives the default yaw, ONLY USED IN CrabDriveContinuous
	 * 
	 * @return
	 */
	public static double getDefaultYaw()
	{
		return m_defaultYaw;
	}
	
	/**
	 * Sets whether to maintain default yaw, ONLY used in CrabDriveContinuous
	 * 
	 * @param yaw
	 */
	public static void setMaintainYaw(boolean maintain)
	{
		m_holdYaw = maintain;
	}
	
	/**
	 * Gets whether to maintain default yaw, ONLY used in CrabDriveContinuous
	 * 
	 * @return
	 */
	public static boolean getMaintainYaw()
	{
		return m_holdYaw;
	}
	
	/**
	 * Sets whether we want to maintain default yaw, ONLY used in
	 * CrabDriveContinuous
	 * 
	 * @param requestYawHold
	 */
	public static void setMaintainYawRequest(boolean requestYawHold)
	{
		m_holdYawControl = requestYawHold;
	}
	
	/**
	 * Gets whether we want to maintain default yaw, ONLY used in
	 * CrabDriveContinuous
	 * 
	 * @return
	 */
	public static boolean getMaintainYawRequest()
	{
		return m_holdYawControl;
	}
}