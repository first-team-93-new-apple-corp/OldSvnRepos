 ...
 *
 */
public class GearLocationFour extends Command {
	Boolean isFinished;
	double PIDTotal;
	int onTargetTotal;

    public GearLocationFour() {
    ...
    protected void initialize() {
    	...
    	else
    	{
    		...
    		{
    			PIDTotal = GearManipulator.EncoderTicks12 + GearManipulator.EncoderTicks23 + GearManipulator.EncoderTicks34;
    		}
    		else if(GearManipulator.location == 2)
    		{
    			PIDTotal = (GearManipulator.EncoderTicks23 + GearManipulator.EncoderTicks34);
    		}
    		else if (GearManipulator.location == 3)
    		{
    			PIDTotal = GearManipulator.EncoderTicks34;
    		}
    	}
    	onTargetTotal = 0;
