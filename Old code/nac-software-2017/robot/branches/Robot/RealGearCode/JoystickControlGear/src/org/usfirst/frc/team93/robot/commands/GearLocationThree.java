 ...
 *
 */
public class GearLocationThree extends Command {
	Boolean isFinished;
	double PIDTotal;
	int onTargetTotal;

    public GearLocationThree() {
    ...
    protected void initialize() {
    	...
    	else
    	{
    		...
    		{
    			PIDTotal = GearManipulator.EncoderTicks23;
    		}
    		else if(GearManipulator.location == 1)
    		{
    			PIDTotal = (GearManipulator.EncoderTicks12 + GearManipulator.EncoderTicks23);
    		}
    		else if(GearManipulator.location == 4)
    		{
    			PIDTotal = GearManipulator.EncoderTicks34 * -1;
    		}
    	}
    	onTargetTotal = 0;
