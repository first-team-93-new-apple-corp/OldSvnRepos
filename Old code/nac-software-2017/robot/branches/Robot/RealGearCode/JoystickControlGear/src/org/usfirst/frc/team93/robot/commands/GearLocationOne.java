 ...
 *
 */
public class GearLocationOne extends Command {
	Boolean isFinished;
	double PIDTotal;
	int onTargetTotal;

    public GearLocationOne() {
    ...
    protected void initialize() {
    	...
    	else
    	{
    		...
    		{
    			PIDTotal = GearManipulator.EncoderTicks12 * -1;
    		}
    		else if(GearManipulator.location == 3)
    		{
    			PIDTotal = (GearManipulator.EncoderTicks12 + GearManipulator.EncoderTicks23) * -1;
    		}
    		else if (GearManipulator.location == 4)
    		{
    			PIDTotal = (GearManipulator.EncoderTicks12 + GearManipulator.EncoderTicks23 + GearManipulator.EncoderTicks34) * -1;
    		}
    	}
    	onTargetTotal = 0;
