...
import org.usfirst.frc.team93.robot.commands.FullSpeedAhead;
import org.usfirst.frc.team93.robot.commands.HalfSpeedAheas;
import org.usfirst.frc.team93.robot.commands.unClimb;
...
public class OI
{
	...
	public static JoystickButton ClimberToggle;
	public static JoystickButton ClimbDown;
	public static JoystickButton halfPercent;
	public static JoystickButton fullPercent;
	...
	public OI()
	{
		...
		ClimberToggle = new JoystickButton(dualActionDriver, 1);
		ClimbDown = new JoystickButton(dualActionDriver, 2);
		...
		ClimberToggle.toggleWhenPressed(new Climb());
		ClimbDown.toggleWhenPressed(new unClimb());
		NoSmoke = 0;
		fullPercent = new JoystickButton(dualActionDriver, 3);
		halfPercent = new JoystickButton(dualActionDriver, 4);
		fullPercent.toggleWhenPressed(new FullSpeedAhead());
		halfPercent.toggleWhenPressed(new HalfSpeedAheas());
		dualActionDriver.setOutput(3, true);
