...
public class TwoEncoderPIDSource implements PIDSource
{
	 ...
	 * @param gainLeft
	 */
	public TwoEncoderPIDSource(Encoder encoderRight, Encoder encoderLeft, double gainRight, double gainLeft)
	{
	...
	public double pidGet()
	{
		...
		double result = (getLeftGain() * m_encoderLeft.pidGet()) + (getRightGain() * m_encoderRight.pidGet());
		return result;
	}
