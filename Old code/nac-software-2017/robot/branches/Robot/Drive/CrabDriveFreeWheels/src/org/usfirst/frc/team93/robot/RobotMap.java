...
public abstract class RobotMap
{
	...
	public int GEAR_GRABBER_TOP_MOTOR;
	public int GEAR_GRABBER_BOTTOM_MOTOR;
	// Gear Manipulator Pneumatics
	public int GEAR_TOP_SOLENOID_PIN_A;
	public int GEAR_TOP_SOLENOID_PIN_B;
	public int GEAR_BOTTOM_SOLENOID_PIN_A;
	public int GEAR_BOTTOM_SOLENOID_PIN_B;
