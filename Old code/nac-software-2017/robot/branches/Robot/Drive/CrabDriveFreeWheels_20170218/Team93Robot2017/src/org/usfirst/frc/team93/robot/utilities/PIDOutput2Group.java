...
public class PIDOutput2Group implements PIDOutput
{
	...
	/**
	 * The Constructor for PIDOutput2Group.
	 * 
	 * @param controllerA
	 *            A PIDController to be merged into a single PIDOutput2Group.
	 * @param controllerB
	...
	/**
	 * The Constructor for PIDOutput2Group. If not specified, the multipliers
	 * default to 1.0.
	 * 
	 * @param controllerA
	 * @param controllerB
	...
	public double get()
	{
		// This acts as a "getter" of sorts for PIDOutput2Groups.
	...
	{
		// This acts as a "setter" of sorts for PIDOutput2Groups.
