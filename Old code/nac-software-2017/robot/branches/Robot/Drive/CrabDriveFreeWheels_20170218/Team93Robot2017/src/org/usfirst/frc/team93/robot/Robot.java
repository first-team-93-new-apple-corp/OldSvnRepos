...
public class Robot extends IterativeRobot {
	...
	{
		drive = new Drive();
		spi = new SPIEncoders(Drive.DRIVE_DIRECTION_SPI_LEFT_FRONT, Drive.DRIVE_DIRECTION_SPI_LEFT_BACK, Drive.DRIVE_DIRECTION_SPI_RIGHT_FRONT, Drive.DRIVE_DIRECTION_SPI_RIGHT_BACK,
				Drive.LFSPI_dummy, Drive.LBSPI_dummy, Drive.RFSPI_dummy, Drive.RBSPI_dummy);
