 ...
 * AveragePIDSource
 * @author Evans Chen
 * This class merges multiple PIDSources into one PIDSource using an arithmetic mean.
 * This is useful for tasks such as averaging Encoders to form one PIDSource.
...
public class MedianPIDSource implements PIDSource
{
	 ...
	 * Makes the supplied source the only source in the AveragePIDSource.
	...
	/**
	 * A default of the overloaded Constructor for the AveragePIDSource with 1 PIDSource. Sets gain to 1.0.
	 * @param source1 The PIDSource
	 */
	...
	/**
	 * A default of the overloaded Constructor for the AveragePIDSource with 2 PIDSources. Sets gain to 1.0.
	 * @param source1 The 1st PIDSource
	 * @param source2 The 2nd PIDSource
	 */
	...
	/**
	 * A default of the overloaded Constructor for the AveragePIDSource with 3 PIDSources. Sets gain to 1.0.
	 * @param source1 The 1st PIDSource
	 * @param source2 The 2nd PIDSource
	 * @param source3 The 3rd PIDSource
	 */
	...
	/**
	 * A default of the overloaded Constructor for the AveragePIDSource with 4 PIDSources. Sets gain to 1.0.
	 * @param source1 The 1st PIDSource
	 * @param source2 The 2nd PIDSource
	 * @param source3 The 3rd PIDSource
	 * @param source4 The 4th PIDSource
