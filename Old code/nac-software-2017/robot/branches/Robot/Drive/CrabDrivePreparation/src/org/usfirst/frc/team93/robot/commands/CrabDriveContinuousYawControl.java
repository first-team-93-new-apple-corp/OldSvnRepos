 ...
 */
public class CrabDriveContinuousYawControl extends Command {
    ...
    public CrabDriveContinuousYawControl() {
    ...
    public CrabDriveContinuousYawControl(CrabDriveMode mode)
    {
    	this();
		m_mode = mode;
    }
    ...
    protected void execute()
    {
    	...
    	double forwardWheelAngle = closestAngle(0, OI.movement.direction().get());
    	//get wheel angle in reverse direction and compare to wheel angle in forward direction
    	double backwardWheelAngle = closestAngle(0 + 180, OI.movement.direction().get());
    	...
    	//System.out.println("GOAL: " + (Drive.GYRO.get() + robotAngle));
    }
    ...
    private double round(double n, double places)
    {
