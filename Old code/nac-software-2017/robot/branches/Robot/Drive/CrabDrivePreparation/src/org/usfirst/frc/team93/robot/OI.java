...
public class OI {
	...
	public OI()
	{
		...
		drive_left_front = new JoystickButton(operator, 7);
		drive_left_front.whenPressed(new TestMotor(Drive.DRIVE_DIRECTION, power, timems));
		drive_right_front = new JoystickButton(operator, 8);
