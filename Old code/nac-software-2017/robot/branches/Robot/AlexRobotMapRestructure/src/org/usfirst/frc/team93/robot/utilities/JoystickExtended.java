 ...
 * @author Evans Chen
 * 
 * This class takes input from a joystick and converts it into 2 PIDSources:
 * A direction PIDSource, which measures what angle the joystick is at
 * A magnitude PIDSource, which measures how far the joystick is from its startpoint
 * x and y PIDSources are provided as well.
 * 
 * Note:
 * This only takes a SINGLE joystick, and its x and y axis, NOT an entire controller, as Joystick usually means.
 * 
...
public class JoystickExtended
{
	...
	public JoystickExtended(Joystick joystick, int x, int y)
	{
		...
		//deadzone is set to 0.1 by default
		m_deadzone = 0.1;
