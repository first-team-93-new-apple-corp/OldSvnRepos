...
public class Drive extends Subsystem {
	...
	public static CrabDriveDirectionPIDSource DRIVE_DIRECTION_SPI;
	...
	public Drive()
	{
		...
		//Aggregation of the 4 SPIEncoderPIDSources
		DRIVE_DIRECTION_SPI = new CrabDriveDirectionPIDSource(DRIVE_DIRECTION_SPI_LEFT_FRONT, DRIVE_DIRECTION_SPI_LEFT_BACK, DRIVE_DIRECTION_SPI_RIGHT_FRONT, DRIVE_DIRECTION_SPI_RIGHT_BACK);
		
		///Actuators
		//Drive Motors
		DRIVE_LEFT_FRONT = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_LEFT_FRONT_PIN));
		DRIVE_LEFT_BACK = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_LEFT_BACK_PIN));
		DRIVE_RIGHT_FRONT =  new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_RIGHT_FRONT_PIN));
		DRIVE_RIGHT_BACK = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_RIGHT_BACK_PIN));
		//Drive Wheel Direction Motors
		DRIVE_DIRECTION_LEFT_FRONT = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_DIRECTION_LEFT_FRONT_PIN));
		DRIVE_DIRECTION_LEFT_BACK = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_DIRECTION_LEFT_BACK_PIN));
		DRIVE_DIRECTION_RIGHT_FRONT = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_DIRECTION_RIGHT_FRONT_PIN));
		DRIVE_DIRECTION_RIGHT_BACK = new PIDOutputExtended(new Talon(RobotMap.getMap().DRIVE_DIRECTION_RIGHT_BACK_PIN));
		...
		//Drive PIDOutputGroup Adjustments...
		...
		DirectionController = new PIDController(0.001, 0, 0, DRIVE_DIRECTION_SPI, DRIVE_DIRECTION);
	}
