...
public class RobotMapReal extends RobotMap
{
	...
	private RobotMapReal()
	{
		///Drive Sensors
		//Encoders
		Encoders.LEFT_DRIVE = new EncoderPin(0, 1);
		...
		///Actuators
		//Drive Speed Motors
		DRIVE_LEFT_FRONT_PIN = 0;
		DRIVE_LEFT_BACK_PIN = 1;
		DRIVE_RIGHT_FRONT_PIN = 2;
		DRIVE_RIGHT_BACK_PIN = 3;
		//Wheel Direction Motors
		DRIVE_DIRECTION_LEFT_FRONT_PIN = 4;
		DRIVE_DIRECTION_LEFT_BACK_PIN = 5;
		DRIVE_DIRECTION_RIGHT_FRONT_PIN = 6;
		DRIVE_DIRECTION_RIGHT_BACK_PIN = 7;
	}
