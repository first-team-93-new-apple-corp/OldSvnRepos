...
public class SPIEncoderPIDSource implements WheelAnglePIDSource
{
	...
	/**
	 * Converts a List of Bytes to its hex representation. This will output
	 * something in the format "[00, AF, 45, 01]" The list {3, 6, 8} would
	 * output: "[03, 06, 08]"
	 * 
	 * @param bytes
	 *            The List<Byte> byte list.
	 ...
	 * @param b
	 * @param period
	 *            The number of ticks in one rotation.
	 * @return
	 */
