...
public class TeleopCamera extends Command
{
	...
	public class RunnableVisionProcessor implements Runnable
	{
		 ...
		 */
		public RunnableVisionProcessor(TeleopCamera teleopCamera)
		{
	...
	synchronized protected void initialize()
	{
		...
		NIVision.IMAQdxSetAttributeString(session, "AcquisitionAttributes::VideoMode", "320 x 240 YUY 2 30.00 fps");
