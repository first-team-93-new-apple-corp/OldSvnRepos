...
public class OI
{
	...
	public OI()
	{
		...
		startShootMotors.toggleWhenPressed(new SetShootWheels(HighSpeed));
		shoot.whenPressed(new ShootBoulder(HighSpeed));
		shootingSetpoint.whenPressed(new SetFiringAngle(90.0));
