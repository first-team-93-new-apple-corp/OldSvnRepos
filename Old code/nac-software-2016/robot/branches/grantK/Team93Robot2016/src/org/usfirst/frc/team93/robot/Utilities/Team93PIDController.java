...
public class Team93PIDController implements LiveWindowSendable 
{
    ...
    private double m_maximumIContribution = 1.0;//Sets the maximum input for I contribution in PID (includes totalError)
    private double m_minimumIContribution = m_maximumIContribution * -1;//Sets the minimum input for I contribution in PID (includes totalError)
     ...
     *            The default is 50ms.
     */
    public Team93PIDController(double Kp, double Ki, double Kd, double Kf,
     ...
     *            The default is 50ms.
     */
    public Team93PIDController(double Kp, double Ki, double Kd,
            PIDSource source, PIDOutput output, double period) 
    {
            ...
            synchronized (this)
            {
                ...
                if (m_I != 0)
                {
                    double potentialIContribution = (m_totalError + m_error) // changed
                            ...
                            * m_I;
                    if (potentialIContribution < m_maximumIContribution) { // changed
                                                                           // m_maximumOutput
                                                                           // to
                                                                           // m_maximumIContribution
                        if (potentialIContribution > m_minimumIContribution) { // changed
                                                                               // m_minimumoutput
                                                                               // to
            ...
            double maximumOutput) 
    {
        ...
        {
            throw new BoundaryException(
                    "Lower bound is greater than upper bound for output");
        }
     ...
     */
    public synchronized void setIContributionRange(double minimumIContribution,
            double maximumIContribution) 
    {
        if (minimumIContribution > maximumIContribution) 
        {
            throw new BoundaryException(
                    "Lower bound is greater than upper bound for input");
        }
