...
public class RobotMap
{
	...
	// Switches
	public static final DigitalInput[] AutoSwitches =
	...
	public static final Encoder scalerEncoder = new Encoder(11, 12, true, EncodingType.k1X);
	...
	// Solenoids
	public static final DoubleSolenoid releaseLeftArm = new DoubleSolenoid(4, 5);
	public static final DoubleSolenoid releaseRightArm = new DoubleSolenoid(6, 7);
	public static final DoubleSolenoid leftScaler = new DoubleSolenoid(0, 1);
	public static final DoubleSolenoid rightScaler = new DoubleSolenoid(2, 3);
}
