...
/**
 * This class uses information from the joystick positions to determine how fast
 * the wheels should go
 */
public class DriveContinuous extends Command
{
	...
	{
		Drive.setLeftMotors(m_scalingFactor * OI.getDriverLY(0.05 * m_scalingFactor));
		Drive.setRightMotors(-m_scalingFactor * OI.getDriverRY(0.05 * m_scalingFactor));
