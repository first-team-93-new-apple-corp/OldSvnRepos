...
/**
 * This utility writes to three pidControllers
 * 
 * @author New Apple Corps Team 93 Controls
 */

// This class allows one to merge two PIDControllers into one
// PIDControllerGroup. The benefits of this are that one can set two
// SpeedControllers at once to the same value if this is wanted, and if the
// motors are linked in some way (e.g. both of the motors on the right, and both
// of the motors on the left, as we want them always going the same direction).

public class PIDOutput3Group implements PIDOutput
{
	 ...
	 * @param gainC
	 *            The multiplier for the third PIDController
	 */
	public PIDOutput3Group(PIDOutput controllerA, PIDOutput controllerB, PIDOutput controllerC, double gainA,
			double gainB, double gainC)
	{
	 ...
	 * @param controllerC
	 */
	public PIDOutput3Group(PIDOutput controllerA, PIDOutput controllerB, PIDOutput controllerC)
	{
	 ...
	 * @param gainC
	 *            Sets the multiplier for The Third PIDController.
	 */
	public void setGains(double gainA, double gainB, double gainC)
	{
	...
	public void set(double speed)
	{
		...
		m_controllerC.pidWrite(speed * m_gainC);
	}
	...
	/**
	 * Gets the gain for the third controller.
	 * 
	 * @return the gainC
	 */
	public double getGainC()
	{
		return m_gainC;
	}
}
