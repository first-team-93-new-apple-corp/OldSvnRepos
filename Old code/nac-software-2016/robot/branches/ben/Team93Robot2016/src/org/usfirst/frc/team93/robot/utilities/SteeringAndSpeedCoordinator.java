...
public class SteeringAndSpeedCoordinator
{
	...
	private class PIDReceiver implements PIDOutput
	{
		 ...
		 */
		public PIDReceiver(PIDReceiverType_t type, SteeringAndSpeedCoordinator master)
		{
			m_type = type;
	 ...
	 *            The right output.
	 */
	public SteeringAndSpeedCoordinator(PIDOutput leftPIDOutput, PIDOutput rightPIDOutput)
	{
		...
		// inputs.
		SpeedReceiver = new PIDReceiver(PIDReceiverType_t.RECEIVER_TYPE_SPEED, this);
		SteeringReceiver = new PIDReceiver(PIDReceiverType_t.RECEIVER_TYPE_STEERING, this);
	}
