...
import org.usfirst.frc.team93.robot.commands.ToggleManipulator;
...
public class OI
{
	...
	public OI()
	{
		...
		Button toggleManipulator = new JoystickButton(driver, 2);

		// Operator Buttons

		Button toggleScaler = new JoystickButton(operator, 5);
		Button moveHighArm = new JoystickButton(operator, 4);

		// Button Functions
		toggleManipulator.whenPressed(new ToggleManipulator(0.3));
	}
