...
public class GameBoard {
	...
	private int m_shot_attempt_count = 0;
	
	public static final int MAX_SHOTS_ALLOWED = 10000;
	...
	public boolean testPlayerAPlacementComplete()
	{
		return (m_player_a.isValid());
	}
	
	public boolean testPlayerBPlacementComplete()
	{
		return (m_player_b.isValid());
	}
	...
	/**
	 * This is for use by logic determining whether to report a winner and advance to the next match.
	 * @return true if a winner is declared, or if the match is taking excessively long (safety feature)
	 */
	public boolean testGameOver()
	{
		return (gameWinner() != PlayerID_t.PLAYER_NULL || m_shot_attempt_count > MAX_SHOTS_ALLOWED );
	}
