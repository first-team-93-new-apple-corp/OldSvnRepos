...
public class Match {
	...
	public void setFirstPlayer(GameBoard.PlayerID_t player)
	{
	...
	/**
	 * Passing these through for tournament forfeit scoring
	 * @return true if Player A finished its placements / is properly initialized
	 */
	public boolean testInitializationPlayerA()
	{
		return m_gameboard.testPlayerAPlacementComplete();
	}
	
	public boolean testInitializationPlayerB()
	{
		return m_gameboard.testPlayerBPlacementComplete();
	}
	...
	public void playStep()
	{
		...
		{
			String playerStr = (GameBoard.PlayerID_t.PLAYER_A == m_next_player) ? "A" : "B";
			String playerName = (GameBoard.PlayerID_t.PLAYER_A == m_next_player) ? m_player_a.getClass().getSimpleName() : m_player_b.getClass().getSimpleName();
			
			if (Tournament.log != null)
			{
				Tournament.log.writeActionHeader(playerStr, playerName);
			}
		}
