...
public class Tournament {
	...
	{
		System.out.println("----- Begin Tournament-coordinated Match Setup -----");
		System.out.println("Match number: " + String.valueOf(m_current_match_num));
	...
	public void playMatch()
	{
		...
		{
			System.out.println("Oceans not initialized.  Verify all ships placed.  The match will not be played.");
		}
		else
		{ 
			// play the match
			...
			System.out.println("----- Begin Tournament-coordinated Match Play -----");
			System.out.println("Player A is a " + player_a_name);
			System.out.println("Player B is a " + player_b_name);
			...
			System.out.println("The game took " + String.valueOf(currentMatch().getShotCount()) + " shots.");
		}//else - play the match
