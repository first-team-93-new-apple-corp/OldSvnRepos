...
public abstract class GamePlayer {
	...
	protected FireResult fireShot(Ship.GridCoord coord)
	{
		...
		print(getName() + " fires at " + String.valueOf(coord.x) + "," + String.valueOf(coord.y));
	...
	{
		print(getName() + " places ship at " + String.valueOf(ship.getLocation().x) + "," + String.valueOf(ship.getLocation().y));
	...
	{
		return getClass().getSimpleName() + " " + m_playerNumber;
	}
