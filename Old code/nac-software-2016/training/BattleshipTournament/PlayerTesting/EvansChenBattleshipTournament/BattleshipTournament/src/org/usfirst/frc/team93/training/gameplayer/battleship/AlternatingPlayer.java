 ...
 *
 */
public class AlternatingPlayer extends GamePlayer {
	...
	int placingStrategyCycleLength = 2;
	int placingCounter = 0;
	PlacingStrategy currentPlacingStrategy = PlacingStrategy.RANDOM;
	
	int firingStrategyCycleLength = 2;
	int firingCounter = 0;
	FiringStrategy currentFiringStrategy = FiringStrategy.RANDOM;
	...
	public AlternatingPlayer(int player) 
	{
		super(player);
		// TODO Auto-generated constructor stub
	}
	...
	public void notifyReset()
	{
		...
		//if toggling time
		if (firingCounter >= firingStrategyCycleLength - 1)
		{
			if (currentFiringStrategy != FiringStrategy.EDGE)
			{
				setFireMode(FiringStrategy.EDGE);
			}
			else
			{
				setFireMode(FiringStrategy.RANDOM);
			}
		}
		firingCounter ++;
	}
	...
	public void placeShips() 
	{
		...
		if (placingCounter >= placingStrategyCycleLength - 1)
		{
			if (currentPlacingStrategy != PlacingStrategy.EDGE)
			{
				placeShips(PlacingStrategy.EDGE);
				System.out.println("SO EDGY");
			}
			else
			{
				placeShips(PlacingStrategy.RANDOM);
