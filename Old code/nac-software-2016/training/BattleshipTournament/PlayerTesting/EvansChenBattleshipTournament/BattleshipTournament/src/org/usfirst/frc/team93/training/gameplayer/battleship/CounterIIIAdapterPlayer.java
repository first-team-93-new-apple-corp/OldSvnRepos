 ...
 *
 */
public class CounterIIIAdapterPlayer extends GamePlayer {
	 ...
	 * @param own_ocean
	 */
	public CounterIIIAdapterPlayer() 
	{
		super();
	...
	public void notifyReset()
	{
		...
		{
			setFireMode(FiringStrategy.CENTER);
		}
		toggle = !toggle;
	}
	...
	public void placeShips() 
	{
		...
		if (toggle)
		{
			placeShips(PlacingStrategy.CENTER);
		}
		else
		{
