...
public class Scenario3 {
	...
	public static void bandaid() {
		System.out.println("you have covered your wound and can now continue on to go get cookies from the kitchen,\nwould you like to open cupboard 1, 2 ,3 or 4? type '1' '2' '3' or '4'");
		scenario3done=true;
