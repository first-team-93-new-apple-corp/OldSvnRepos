	...
	public static void pickScenario(){
		if(endGame==true) {
			...
			if(playerInput.equals("2") || playerInput.equals("4")) {
				...
				Scenario4.needToFindAntedote = false;
			}
		}
			...
			while(Scenario1.pickFlashlight == false) {
				String playerInput = Main.sc.nextLine();
				if (playerInput.equals("1")) {
					Scenario3.bandaid();
					Main.playerType=true;
			...
			while(Scenario2.cupboard1==true) {
				String playerInput = Main.sc.nextLine();
				if (playerInput.equals("1")) {
					Scenario4.magic();
					Main.playerType=true;
			...
			while(Scenario2.cupboard2==true) {
				String playerInput = Main.sc.nextLine();
				if (playerInput.equals("1")) {
					Scenario5.milk();
					Main.playerType=true;
			...
			while(Scenario2.cupboard4==true) {
				String playerInput = Main.sc.nextLine();
				if (playerInput.equals("1")) {
					Scenario7.portal();
					Main.playerType=true;
		...
		else if (Scenario2.scenario2done==true && Scenario5.milkIsSpoiled == true) {
			while(Scenario5.milkIsSpoiled==true) {
				String playerInput = Main.sc.nextLine();
				if (playerInput.equals("1")) {
					Scenario6.store();
					Main.playerType=true;
