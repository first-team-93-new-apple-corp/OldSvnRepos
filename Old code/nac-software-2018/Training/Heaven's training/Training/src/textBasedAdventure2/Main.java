...
public class Main {
	...
	{
		System.out.println("you wake up and look at the clock, it's 1:07 AM, you try falling asleep but find yourself to be too hungry to do so, you decide to walk downstairs to get some cookies, do you take your flashlight? type '1' for yes and '2' for no");
		playerType = true;
