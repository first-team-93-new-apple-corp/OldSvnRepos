 ...
 *
 */
public class RightLeftSwitchBefore extends CommandGroup
{
	
	public RightLeftSwitchBefore()
	{
		// addSequential(new SleepCommand(SmartDashboard.getNumber("TimeBeforeAuto",
		// 0)));
