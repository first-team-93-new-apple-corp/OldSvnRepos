...
public abstract class POVAsButton extends Button
{
	...
	private static int m_iThreshold = 44;
	...
	public boolean get()
	{
		...
		int iThreshold = m_iThreshold;
		if (iTarget == 0)
		{
			return ((iPosition > 360 - iThreshold) && (iPosition < iTarget + iThreshold));
		}
		else
		{
			return ((iPosition > iTarget - iThreshold) && (iPosition < iTarget + iThreshold));
		}
	}
