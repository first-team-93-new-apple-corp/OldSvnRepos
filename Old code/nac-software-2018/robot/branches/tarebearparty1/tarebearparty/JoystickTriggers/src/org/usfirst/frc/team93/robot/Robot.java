...
import org.usfirst.frc.team93.robot.Robot.camera_config_t;
...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		DriveMode.addDefault("1 Controller", 1);
		DriveMode.addObject("2 Joysticks", 2);
		DriveMode.addObject("1 Controller split axis", 3);
		DriveMode.addObject("2 Joysticks split axis", 4);
		robotMap = new RobotMap();
		// chooser.addObject("My Auto", new MyAutoCommand());
		SmartDashboard.putData("DriveMode", DriveMode);
		drive = new Drive();
		m_oi = new OI();
