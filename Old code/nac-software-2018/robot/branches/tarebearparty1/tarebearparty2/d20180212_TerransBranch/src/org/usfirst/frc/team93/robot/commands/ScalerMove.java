...
public class ScalerMove extends ScalerVelocity
{
	...
	double ScaleTickTarget;
	
	public ScalerMove(Scaler.ScalerLocation scaleLocaion)
	{
	...
	{
		return (((Math.abs(getVelocity()) <= Scaler.ScalerMinSpeed) && Scaler.ScaleController.onTarget())
				|| (m_scaleLocation == Scaler.ScalerLocation.TOP && Scaler.topLimit.get())
				|| m_scaleLocation == Scaler.ScalerLocation.BOTTOM && Scaler.bottomLimit.get());
	}
