...
public class Drive extends Subsystem
{
	...
	public Drive()
	{
		...
		// LeftDriveEncoder = new Encoder(RobotMap.LeftDriveEncoderA,
		// RobotMap.LeftDriveEncoderB);
		// RightDriveEncoder = new Encoder(RobotMap.RightDriveEncoderA,
		// RobotMap.RightDriveEncoderB);
		...
		// LeftWheelDrive = new PIDController(0.005, 0.00055, 0.022, relativeLeft,
		// LeftInverted);
		
		// RightWheelDrive = new PIDController(0.005, 0.00055, 0.022, relativeRight,
		// RightInverted);
	}
