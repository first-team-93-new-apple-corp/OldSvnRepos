...
public class Scenario2 {
	...
	public static void cupboard1(){
		System.out.println("you open the first cupboard and find a magic spell book,\nwould you like to use it to make your cookies? type '1' for yes and '2' for no");
		scenario2done = true;
		cupboard1=true;
	}
	public static void cupboard2(){
		System.out.println("you open the second cupboard and find the cookies,\nwould you like to eat them with out without milk? type '1' for milk and '2' for no milk");
		scenario2done = true;
		cupboard2=true;
	}
	public static void cupboard3(){
		System.out.println("you open the third cupboard and find an antedote,\nwhich cupboard would you like to open next? type '1' '2' or '4'");
	}
	public static void cupboard4(){
		System.out.println("you open the fourth cupboard and find a portal to another world,\ndo you enter? type '1' for yes and '2' for no");
		scenario2done = true;
		cupboard4=true;
	}
