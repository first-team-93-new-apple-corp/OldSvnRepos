...
public class Robot extends TimedRobot
{
	...
	{
		CONTROLLER_TANK, JOYSTICK_TANK, CONTROLLER_SPLIT_AXIS, JOYSTICK_SPLIT_AXIS, CONTROLLER_ARCADE, JOYSTICK_ARCADE
	}
	
	/**
	 * 
	 * @author alex.stevenson
	 *         Used for Autonomus, determining starting position of robot
	 */
	...
	final public camera_config_t camerasEnabled = camera_config_t.CAMERAS_DISABLED;
	...
	public void robotInit()
	{
		...
		SelectedDriveMode.addDefault("1 Controller", DriveMode.CONTROLLER_TANK);
		SelectedDriveMode.addObject("2 Joysticks", DriveMode.JOYSTICK_TANK);
		SelectedDriveMode.addObject("1 Controller split axis", DriveMode.CONTROLLER_SPLIT_AXIS);
		SelectedDriveMode.addObject("2 Joysticks split axis", DriveMode.JOYSTICK_SPLIT_AXIS);
		SelectedDriveMode.addObject("Arcade drive - controller", DriveMode.CONTROLLER_ARCADE);
	...
	{
		Scheduler.getInstance().run();
		SmartDashboard.putNumber("LEncoder Val", Drive.LeftDriveEncoder.getRaw());
		SmartDashboard.putNumber("REncoder Val", Drive.RightDriveEncoder.getRaw());
	}
