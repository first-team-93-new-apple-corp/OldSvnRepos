	...
	public static double getDriverL()
	{
		switch (Drive.driveControlMode)
		{
			case JOYSTICK_TANK:
				...
				return getModifiedAxis(CutOff((deadzone(OI.splitDriverControlOne.getRawAxis(1), OI.ControllerDeadzone)),
	...
	public static double getDriverR()
	{
		switch (Drive.driveControlMode)
		{
			case JOYSTICK_TANK:
				...
				return getModifiedAxis(deadzone(OI.splitDriverControlTwo.getRawAxis(1), OI.ControllerDeadzone));
			case JOYSTICK_SPLIT_AXIS:
