...
public class DriveEncoderTicks extends PIDDriveVelocity
{
	...
	protected boolean isFinished()
	{
		...
		SmartDashboard.putNumber("LPidError", Drive.LeftWheelDrive.getError());
		SmartDashboard.putNumber("RPidError", Drive.RightWheelDrive.getError());
		SmartDashboard.putNumber("ROutputValue", Drive.RightInverted.get());
		SmartDashboard.putNumber("LOutputValue", Drive.LeftInverted.get());
		return (Drive.LeftWheelDrive.onTarget() && Drive.RightWheelDrive.onTarget());
	}
