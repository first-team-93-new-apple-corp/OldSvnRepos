...
public class Robot extends TimedRobot
{
	...
	public static SendableChooser<AutoPath> FrontOrBack;
	...
	public void robotInit()
	{
		...
		if (Robot.isReal())
		{
			// if (camerasEnabled == camera_config_t.CAMERAS_FULL || camerasEnabled ==
			// camera_config_t.CAMERAS_SINGLE_TEST)
			// {
	...
	{
		// System.out.println(DriverStation.getInstance().getGameSpecificMessage().substring(0,
		// 2));
		
		String sFMSData = DriverStation.getInstance().getGameSpecificMessage().substring(0, 2);
		
		if (sFMSData.equals("RR"))
		{
		...
		{
			m_autonomousCommand = new LeftToLeftSwitchFromSide();
			System.out.println("SWITCH");
		}
		else
		{
			m_autonomousCommand = new LeftToLeftScale();
			System.out.println("SCALE");
		}
		
		// if (sFMSData.equals("RR") || sFMSData.equals("RL"))
		// {
		// m_autonomousCommand = (new MiddleToRightSwitch());
		//
		// System.out.println("RIGHT");
		// }
		// else
		// {
		// m_autonomousCommand = new MiddleToLeftSwitch();
		// System.out.println("LEFT");
		// }
		
		// if (DriverStation.getInstance().getGameSpecificMessage().substring(0,
		// 2).equals("RR")
		// || DriverStation.getInstance().getGameSpecificMessage().substring(0,
		// 2).equals("RL"))
		// {
		//
		// }
	...
	public void teleopPeriodic()
	{
		...
		SmartDashboard.putNumber("LWheelDriveError", Drive.LeftWheelDrive.getError());
		SmartDashboard.putNumber("RWheelDriveError", Drive.RightWheelDrive.getError());
		SmartDashboard.putNumber("LWheelDriveValue", Drive.left.get());
		SmartDashboard.putNumber("RWheelDriverValue", Drive.right.get());
	}
