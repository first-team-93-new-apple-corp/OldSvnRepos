...
public class Drive extends Subsystem
{
	...
	public static final int ABSOLUTEDRIVEPIDTOLERANCES = 75;
	public static final int ONEFOOTPIDTOLERANCES = 5;
	...
	public static Team93PIDController LeftOneFoot;
	public static Team93PIDController RightOneFoot;
	
	public static Team93PIDController LeftTurn;
	public static Team93PIDController RightTurn;
	...
	public Drive()
	{
		...
		TurnPID = new PIDController(0.01, 0.0003, 0.05, gyro, turn);
		...
		LeftWheelDrive = new PIDController(0.003, 0.000001, 0.035, relativeLeft, LeftInverted);
		
		RightWheelDrive = new PIDController(0.003, 0.000001, 0.035, relativeRight, right);
		
		LeftOneFoot = new Team93PIDController(0.008, 0.000005, 0.02, relativeLeft, LeftInverted);
		RightOneFoot = new Team93PIDController(0.008, 0.000005, 0.02, relativeRight, right);
		
		LeftTurn = new Team93PIDController(0.008, 0.000005, 0.02, relativeLeft, LeftInverted);
		RightTurn = new Team93PIDController(0.008, 0.000005, 0.02, relativeRight, right);
	}
