...
public class ManipulatorContinuousWithoutWristRENAMED extends Command {

  final double voltsToDegreesForManualWrist = 1;

  public ManipulatorContinuousWithoutWristRENAMED() {
  ...
  protected void execute() {
    System.out.println("MANIPULATORCONTINUOUSWITHOUTWRIST");
    ...
    switch(OI.operator.getPOV())
    {
      ...
      //     ChainedServos.set((.349855 * (Manipulator.rotateWristSensor.getVoltage() - 4.57)) + 1 );  //TROUBLESHOOT THIS
      //     Manipulator.wristRotator.set(OI.getOperatorStick() /** PLUS FORMULA TO FIGURE OUT REQUIRED OFFSET VOLTAGE */); //todo figure out formula
      //   }
      //   Manipulator.kicker.set(0);
      //   break;
