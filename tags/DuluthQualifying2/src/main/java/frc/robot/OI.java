...
import frc.robot.commands.pickupHatchOffGround;
import frc.robot.commands.pickupHatchOffLoadingStation;
...
public class OI {
	...
	public OI()
	{
		...
		setWristUp.whenPressed(new angleWrist(true));

		setWristDown = new JoystickButton(operator, 5);
		setWristDown.whenPressed(new angleWrist(false));
