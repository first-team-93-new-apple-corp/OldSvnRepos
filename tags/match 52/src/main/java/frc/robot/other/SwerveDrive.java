...
public class SwerveDrive {
    ...
    private static final double length = 27.25;
    private static final double width = 23;
    ...
    private static CentricMode centricMode = CentricMode.FIELD;
    ...
    public static void setRelativeMode(CentricMode mode)
    {
        centricMode = mode;
    }
    public static CentricMode getRelativeMode()
    {
        return centricMode;
    }
}
