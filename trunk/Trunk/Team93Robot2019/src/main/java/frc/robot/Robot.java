...
import frc.robot.commands.cargoGameStart;
...
public class Robot extends TimedRobot {
	...
	StartGame startGame;
	public static Boolean hasEndedStartGame;

	public static Boolean hasChangedEndgameSetpoint;
	...
	public static Servo ohShootServo;
	public static Boolean activateOhShootServo;
	public static cargoGameStart cargogamestart;
	...
	public void robotInit() {
		...
		limeLight = new Limelight();
		hasEndedStartGame = false;
		activateOhShootServo = false;
		ohShootServo = new Servo(4);
		hasChangedEndgameSetpoint = false;
	}
	...
	public void autonomousInit() {
		...
		cargogamestart = new cargoGameStart();
		cargogamestart.start();
		//startGame.start();
		/*
	...
	public void autonomousPeriodic() {
		...
		SmartDashboard.putNumber("BACK ELEVATOR VALUE", Manipulator.habLiftEncoder.get());
		
		SmartDashboard.putNumber("Roll", Drive.rollAsPIDSource.pidGet());
		...
		SmartDashboard.putBoolean("HAS INTAKEN BEGINNING THING", hasEndedStartGame);
		...
		{
			System.out.println("WERE IN THE ENDGAME NOW");
			System.out.println("DONT FALL!");
		}
		SmartDashboard.putNumber("ENDGAME SENSOR", Drive.rightHabdetector.getVoltage());
		SmartDashboard.putBoolean("Endgame threshold", !(Drive.rightHabdetector.getVoltage() > 0.3));
		//System.out.println("TELEOP MODE");	
		SmartDashboard.putBoolean("OH SHOOT SERVO", activateOhShootServo);


		if(activateOhShootServo)
		{
			ohShootServo.set(0.05);
		}
		else{
			ohShootServo.set(0.5);
		}
	}
	...
	public void teleopPeriodic() {
		...
		{
			System.out.println("OH CRAP OH SHOOT OH HECK");
		}
	}
