...
import org.usfirst.frc.team93.robot.commands.DriveWithJoystick;
...
public class DriveTrain extends Subsystem {
	// Subsystem devices
	public SpeedController m_frontLeftCIM = new Victor(1);
	public SpeedController m_frontRightCIM = new Victor(2);
	public SpeedController m_rearLeftCIM = new Victor(3);
	public SpeedController m_rearRightCIM = new Victor(4);
	public SpeedControllerGroup m_leftCIMs = new SpeedControllerGroup(
