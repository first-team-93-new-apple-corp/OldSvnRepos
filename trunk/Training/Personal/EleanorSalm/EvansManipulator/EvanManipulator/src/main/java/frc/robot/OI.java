...
public class OI {
  ...
  public static JoystickButton ToggleCargoMover;
  public static JoystickButton ToggleEntireMovement; 


  public OI() {
    driver = new Joystick(0);
    ToggleCargoMover = new JoystickButton(driver, 1);
    ToggleD_HatchMover = new JoystickButton(driver, 2);
    ToggleEntireMovement = new JoystickButton(driver, 3);


    ToggleCargoMover.whenPressed(new CargoMover());
